...
if __name__ == '__main__':
    ...
    parser.add_argument('--data-path', type = str, default = 'data/templates/animel122/smaller_animel_box.obj',
					    help = 'Path of template .obj data.')
    parser.add_argument('--output-dir', type = str, default = 'data/templates/animel122',
